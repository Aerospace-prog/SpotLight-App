...
export default function Post({ post }: PostProps) {
  ...
  return (
    <View style={[styles.post, { borderRadius: 16, marginBottom: 18, backgroundColor: COLORS.surface, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.10, shadowRadius: 8, elevation: 6 }]}>
      {/* POST HEADER */}
